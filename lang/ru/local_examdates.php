...
$string['confirm_apply_text_paged'] = 'Для производительности предпросмотр разбит на страницы. При применении будут обработаны все <strong>{$a->total}</strong> курсов выбранной области пакетами в фоновой задаче. Продолжить?';
...
$string['messageprovider:apply_complete'] = 'Уведомление о завершении массового обновления дат экзаменов';
...
$string['preview_page_stats_message'] = 'Текущая страница: будет изменено {$a->tests} тестов в {$a->courses} курсах; отсутствует тестов: {$a->errors}. Показано {$a->shown} из {$a->total} курсов.';
